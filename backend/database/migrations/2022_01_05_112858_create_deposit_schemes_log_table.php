...
class CreateDepositSchemesLogTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('deposit_schemes_log', function (Blueprint $table) {
            $table->id();
            ...
            $table->decimal('max_amount',15)->nullable();
         ...
         Schema::table('deposit_schemes_log', function (Blueprint $table) {
            $table->foreign('scheme_id')->references('id')->on('deposit_schemes');
        });
    }
    ...
    {
        Schema::dropIfExists('deposit_schemes_log');
    }
}
