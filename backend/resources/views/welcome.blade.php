...
<script>
    livXmppConnection.initialize({
        bosh_service_url: 'http://139.59.28.18:5280/http-bind',
        auth_credential_get_url: 'https://beta.oricoms.com/api/chat_api',
        host: 'localhost',
        emoticons: true,
        auto_login: false,
        external_msg_store: true,
        external_msg_store_url: 'https://beta.oricoms.com/api/save_chat_logs'
    });
</script>